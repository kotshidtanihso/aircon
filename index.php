...
s1.async=true;
s1.src='https://embed.tawk.to/6a4c11ba634c491d47a399ce/1jssiah9i';
s1.charset='UTF-8';
            ...
            <div class="navbar-nav mx-auto bg-light pe-4 py-3 py-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light border-0 m-0">
                        ...
                        <a href="#" class="dropdown-item">Service Details</a>
                    </div>
                </div>
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light border-0 m-0">
                        ...
                        <a href="#" class="dropdown-item">Prices</a>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <h4 class="mb-4">Receive messages instantly with our PHP and Ajax contact form - available in the <a href="https://htmlcodex.com/downloading/?item=2574">Pro Version</a> only.</h4>
                    <form>
                        <div class="row g-3">
                            <div class="col-md-6">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-end">
                        ...
                        <!--/*** If you wish to remove this credit link, please purchase the Pro Version from https://htmlcodex.com/downloading/?item=2574 ***/-->
